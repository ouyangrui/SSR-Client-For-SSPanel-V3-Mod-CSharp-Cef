...
namespace GlobalVaribles
{
    ...
    {
        // 其他信息
        public static bool isConencted = false;
        public static bool isUnknown = false;
        ...
        public static string LOGIN_protocol = null;
        public static string LOGIN_obfs = null;
        // CEF
...
{
    // 全局变量申明位置
    public class ShadowsocksVaribles
    {
